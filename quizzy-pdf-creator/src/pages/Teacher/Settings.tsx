            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <div className="pl-8 space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <label htmlFor="resultNotifications" className="text-softWhite/90">
                      Result Notifications
                    </label>
                    <button
                      onClick={() => handleToggle('resultNotifications')}
                      className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                        settings.resultNotifications ? 'bg-neonCyan' : 'bg-deepBlue border border-softWhite/20'
                      }`}
                    >
                      <span
                        className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
                          settings.resultNotifications ? 'translate-x-6' : 'translate-x-1'
                        }`}
                      />
                    </button>
                  </div>
              ...
              <div>
                ...
                <div className="pl-8 space-y-4">
                  ...
                  <p className="text-sm text-softWhite/60">
                    When enabled, student information will be anonymized in reports and test results.
                  </p>
                </div>
              </div>
