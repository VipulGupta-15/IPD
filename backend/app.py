...
CORS(app, 
     resources={r"/*": {
         "origins": ["http://localhost:8080", "http://localhost:4040", "http://localhost:3000","https://frontend-8u84.onrender.com"],
...
def after_request(response):
    ...
    if origin in ["http://localhost:8080", "http://localhost:5173", "http://localhost:3000","https://frontend-8u84.onrender.com"]:
