        ...
        <div className="p-4 md:p-6">
          ...
          {activeMenu === 'students' && (
            <div className="glass-card p-6">
              ...
              <p className="text-white/70 mt-2">Student management coming soon!</p>
            </div>
          )}
          {activeMenu === 'scheduleTests' && (
            <div className="glass-card p-6">
              <h2 className="text-xl font-medium">Schedule Tests</h2>
              <p className="text-white/70 mt-2">Test scheduling coming soon!</p>
            </div>
          )}
          {activeMenu === 'settings' && (
            <div className="glass-card p-6">
              <h2 className="text-xl font-medium">Settings</h2>
              <p className="text-white/70 mt-2">Settings coming soon!</p>
            </div>
          )}
        </div>
      </main>
